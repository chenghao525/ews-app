...
function designA5(param){
	
	LODOP.NewPage();
	if(param.ORDER_TYPE=='410'){
		designAA5(param);//保单(垫付)
...
if(param.PRESENT_CODE&&param.PRESENT_CODE!=""){
LODOP.ADD_PRINT_TEXT(512,180,53,20,"经办人：");
LODOP.SET_PRINT_STYLEA(0,"FontSize",8);
LODOP.ADD_PRINT_TEXT(511,233,65,20,param.AGENTER);
LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
LODOP.ADD_PRINT_TEXT(513,298,55,25,"打印时间：");
LODOP.SET_PRINT_STYLEA(0,"FontSize",6);
LODOP.SET_PRINT_STYLEA(0,"FontColor","#808080");
LODOP.SET_PRINT_STYLEA(0,"Alignment",3);
LODOP.ADD_PRINT_TEXT(513,353,119,25,new Date().pattern("yyyy-MM-dd hh:mm:ss"));
LODOP.SET_PRINT_STYLEA(0,"FontSize",6);
LODOP.SET_PRINT_STYLEA(0,"FontColor","#808080");
LODOP.SET_PRINT_STYLEA(0,"Alignment",3);
LODOP.SET_PRINT_STYLEA(0,"Horient",1);
LODOP.ADD_PRINT_LINE(546,519,329,769,2,0);
LODOP.ADD_PRINT_TEXT(495,600,175,20,param.ORDER_NUM);
LODOP.SET_PRINT_STYLEA(0,"FontSize",9);
LODOP.SET_PRINT_STYLEA(0,"FontColor","#808080");
LODOP.SET_PRINT_STYLEA(0,"Alignment",2);
LODOP.SET_PRINT_STYLEA(0,"Angle",42);
LODOP.ADD_PRINT_TEXT(515,613,180,45,param.PRESENT_CODE);
LODOP.SET_PRINT_STYLEA(0,"FontSize",12);
LODOP.SET_PRINT_STYLEA(0,"Alignment",2);
LODOP.SET_PRINT_STYLEA(0,"Bold",1);
LODOP.SET_PRINT_STYLEA(0,"Angle",42);
