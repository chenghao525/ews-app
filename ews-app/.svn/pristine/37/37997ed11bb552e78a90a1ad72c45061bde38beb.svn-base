...
class EfficiencyRpt extends Component{
    ...
    render() {
        const { vendors, paint, adjuster} = this.props;
        ...
        return (
            <div>
                ...
                <table id="table" style={{width: '80%',textAlign:'center',margin: 'auto',height: '100px',border:"1px solid #cad9ea"}}  dangerouslySetInnerHTML={{__html: thisIsMyCopy}} border="true" />
                </div>
            </div>
        );
    }
