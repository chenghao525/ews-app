        ...
        return (
            <Form className="ant-advanced-search-form" onSubmit={this.handleSearch}  >
                <Row span={24} style={{marginTop:'5px'}}>
                    <Col span={8}>
                        <Button  type="primary" style={{ marginLeft: 8 }} onClick={this.syncForm} size="small"> <Icon type="snippets" />再次同步</Button>
                        <Button type="primary" style={{ marginLeft: 8 }} htmlType="submit" size="small"><Icon type="redo" />刷新</Button>
                    </Col>
                </Row>
