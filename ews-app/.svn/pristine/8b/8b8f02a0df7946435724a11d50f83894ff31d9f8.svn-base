...
const httpHost = "http://ewstest.wedrive.com.cn";

export const serverURL = `${httpHost}/AjaxService?method=`;
export const serverCommonListURL = `${httpHost}/AjaxService?method=GetCommonList&code=`;
