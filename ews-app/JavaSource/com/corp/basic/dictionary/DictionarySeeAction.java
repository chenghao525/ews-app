...
public class DictionarySeeAction implements BusinessAction {
    ...
    Exception {
		...
		String sql="";
		sql="select * from T_MAP_TRANS_DIC where SID="+frm.getSid();
		
		frm.setT_MAP_TRANS_DIC(dm.findByPrimaryKey(sql,null));
