...
public class EmpSelForm extends FrameForm {
	/**
	 * 
	 */
	private static final long serialVersionUID = -6766648979038312950L;
	...
	// 是否需要并显示人员的手机
	private String needmb;

	// 显示的最低职务级别
	private String dutylmt;
	...
	public String getNeedmb() {
		return needmb;
	}

	public void setNeedmb(String needmb) {
		this.needmb = needmb;
	}

	public String getEmpmbchk() {
		return empmbchk;
	}

	public void setEmpmbchk(String empmbchk) {
		this.empmbchk = empmbchk;
	}

	public String getDutylmt() {
		return dutylmt;
	}

	public void setDutylmt(String dutylmt) {
		this.dutylmt = dutylmt;
	}
